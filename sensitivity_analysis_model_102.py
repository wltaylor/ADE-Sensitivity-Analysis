...
# save results
total_Si_early.to_csv('results/total_Si_early_102.csv', index=True)
first_Si_early.to_csv('results/first_Si_early_102.csv', index=True)
second_Si_early.to_csv('results/second_Si_early_102.csv', index=True)
total_Si_peak.to_csv('results/total_Si_peak_102.csv', index=True)
first_Si_peak.to_csv('results/first_Si_peak_102.csv', index=True)
second_Si_peak.to_csv('results/second_Si_peak_102.csv', index=True)
total_Si_late.to_csv('results/total_Si_late_102.csv', index=True)
first_Si_late.to_csv('results/first_Si_late_102.csv', index=True)
second_Si_late.to_csv('results/second_Si_late_102.csv', index=True)
