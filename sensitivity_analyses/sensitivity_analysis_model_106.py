...
for i,X in enumerate(param_values):
    Y_early[i], Y_peak[i], Y_late[i], concentrations_, times_ = model.concentration_106_all_metrics_adaptive(times,X[0],X[1],X[2],X[3],X[4],X[5],X[6],1,L)
    print(i)
...
# save results
total_Si_early.to_csv('results/total_Si_early_106.csv', index=True)
first_Si_early.to_csv('results/first_Si_early_106.csv', index=True)
second_Si_early.to_csv('results/second_Si_early_106.csv', index=True)
total_Si_peak.to_csv('results/total_Si_peak_106.csv', index=True)
first_Si_peak.to_csv('results/first_Si_peak_106.csv', index=True)
second_Si_peak.to_csv('results/second_Si_peak_106.csv', index=True)
total_Si_late.to_csv('results/total_Si_late_106.csv', index=True)
first_Si_late.to_csv('results/first_Si_late_106.csv', index=True)
second_Si_late.to_csv('results/second_Si_late_106.csv', index=True)
